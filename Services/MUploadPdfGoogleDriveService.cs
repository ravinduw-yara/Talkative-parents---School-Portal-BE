...
public class MUploadPdfGoogleDriveService
{
    private readonly DriveService _service;
    private const string FolderId = "1lUBr6pU903r6wcscwm2XY0Ofb47HWpfw"; // The ID of your Google Drive folder

    public MUploadPdfGoogleDriveService(string azureConnectionString, string blobContainerName, string blobName)
    {
    ...
    public string UploadFile(IFormFile file, int academicYearId, int gradeId, int subjectId, int semesterId, int examId, int questionPaperTypeId)
    {
        ...
        string folderId = GetOrCreateNestedFolderStructure(academicYearId, gradeId, subjectId, semesterId, examId, questionPaperTypeId);
    ...
    private string GetOrCreateNestedFolderStructure(int academicYearId, int gradeId, int subjectId, int semesterId, int examId, int questionPaperTypeId)
    {
        ...
        currentFolderId = GetOrCreateSubFolder(currentFolderId, questionPaperTypeId.ToString());
